...
| Component | Job |
| --- | --- |
| Control plane | Owner session, Q&A, graph editing, review, approval, and export |
...
| Build-pack exporter | Portable `.factory/` files for any harness |
| Runner | Optional bounded task execution in isolated Git worktrees |
| Edge Worker | Optional static assets and API proxy |
