/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 316feb2640fe77284625d57bf54f3c8e)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	BUILD_PACKS: R2Bucket;
	DB: D1Database;
	MODEL_JOBS: Queue;
	ASSETS: Fetcher;
	ENVIRONMENT: "production";
	APP_ORIGIN: "https://graphslop.com";
	MODEL_RUNNER_TOKEN: string;
	PROJECTS: DurableObjectNamespace<import("./src/index").ProjectWorkbench>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ProjectWorkbench";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_ORIGIN" | "MODEL_RUNNER_TOKEN">> {}
}
